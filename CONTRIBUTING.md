# Contributing to `Prefers Scan`

Thank you for considering contributing to **`Prefers Scan`**! We're excited to have you be part of the project. To make your contribution smooth and valuable, please follow the guidelines outlined below.
...
3. **Make Changes**  
   Modify the unminified `src/prefers-scan.js` file (avoid editing the minified version directly). Ensure your changes work correctly by testing them.
...
- Visit the [GitHub Issues](https://github.com/MewenLeHo/prefers-scan/issues) page to search for answers or create a new issue.
...
We appreciate your help in making **`prefers-scan`** better and your valuable contributions!
